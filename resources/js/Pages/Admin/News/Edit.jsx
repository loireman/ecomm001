...
export default function EditTovary({ auth, news }) {
    const { data, setData, post, processing, errors, reset } = useForm({
        name: news.name,
        slug: news.slug,
        body: news.body,
        photo_path: news.photo_path ? JSON.parse(news.photo_path) : [],
    });
    ...
    const submit = async (e) => {
        ...
        Inertia.put(route("news.update", { news: news }), {
            name: data.name,
            slug: data.slug,
            body: data.body,
