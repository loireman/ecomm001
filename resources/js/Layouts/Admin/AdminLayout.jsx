...
export default function Authenticated({ user, header, children }) {
    ...
    return (
        <div className="flex min-h-screen bg-gray-100 dark:bg-gray-900">
            {navigationFull ? (
                <div className="flex flex-col items-center w-64 min-h-screen fixed overflow-hidden text-gray-400 bg-gray-900 border-r-2 border-gray-800">
                    <button
                        onClick={() => setNavigationFull(false)}
                        className="flex w-full items-center justify-center mt-3"
                    >
                        <ApplicationLogo
                            width="32"
                ...
                <div className="min-h-screen fixed flex flex-col items-center w-16 overflow-hidden text-gray-400 bg-gray-900 border-r-2 border-gray-800">
                    <button
